...
<head>
    <title>Down the Stream | Free Web Template by WebTemplateOcean.com</title>
...
<body>
    <div id="page">        
        <div id="header">
            <h1><a href="#">Down the Stream</a></h1>
        ...
        <div id="page2"> 
            ...
            <div id="footer">
                <p>Copyright &copy; 2012, designed by <a href="http://www.webtemplateocean.com/">WebTemplateOcean.com</a>
</p>
            </div>
        </div><!-- page2 -->
    </div><!-- page -->
